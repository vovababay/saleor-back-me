...
class Sale(CountableDjangoObjectType):
    ...
    periodically_change = graphene.Boolean() # Статус менять ли скидку динамически
    ...
    class Meta:
        ...
        model = models.Sale
        only_fields = ["end_date", "id", "name", "start_date", "type", "value", "periodically_change", "value_discount", "value_frequency"]
    ...
    @staticmethod
    def resolve_periodically_change(root: models.Sale, info, **_kwargs):
        return root.periodically_change
    
    @staticmethod
    def resolve_value_discount(root: models.Sale, info, **_kwargs):
        return root.value_discount

    @staticmethod
    def resolve_value_frequency(root: models.Sale, info, **_kwargs):
        return root.value_frequency
