...
from . import DiscountValueType, VoucherType, DiscountFrequencyType
...
class Sale(models.Model):
    ...
    periodically_change = models.BooleanField(default=False, verbose_name="Переодически изменять стоимость")
