...
# EMAIL_PORT = 465
# EMAIL_HOST_USER = "v_babaev@webjox.ru"
# EMAIL_HOST_PASSWORD = "mqjbenwavdqljxhi"#
# EMAIL_USE_TLS = False
# EMAIL_USE_SSL = True
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,192.168.0.51,192.168.0.37"))
...
PLUGINS = [
    ...
    "saleor.payment.gateways.tinkoff.plugin.TinkoffGatewayPlugin",
